...
const PUBLIC_MINT_START_DATE = "2022-10-16T11:30:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00
...
const PRESALE_WHITELISTED_ADDRESSES = [0x446aF58CCE226D21Bc9e156C60D98E3BB676D113]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_TITLE = "KATRSRE"; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
